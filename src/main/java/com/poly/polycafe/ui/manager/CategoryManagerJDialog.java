...
import com.poly.polycafe.controller.CategoryController;
...
public class CategoryManagerJDialog extends javax.swing.JDialog implements CategoryController {
    ...
    private void initComponents() {
        ...
        tblCategories.setSelectionBackground(new java.awt.Color(255, 102, 0));
...
GenericDAO<Categories, String> dao = new GenericDAO<>(Categories.class);
...
public void update() {
     String id  = txtId.getText();
        Categories cat = dao.findById(id);
        
         if (cat != null) {
            cat.setId(this.getForm().getId());
            cat.setName(this.getForm().getName());
            dao.update(cat);        
            this.clear();
        fillToTable();
        } else {
...
public void delete() {
    try {
            ...
            if (id.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Chưa nhập mã để xóa!");
                return;
            }
            ...
            if (cat == null) {
                JOptionPane.showMessageDialog(this, "Không tìm thấy loại đồ uống có mã " + id);
                return;
            }

            int confirm = JOptionPane.showConfirmDialog(
                    this,
                    "Bạn có chắc muốn xóa loại đồ uống \"" + id + "\" không?",
                    "Xác nhận xóa",
...
public void moveTo(int index) {
    ...
    public void exportExcel() {
        if(tblCategories.getRowCount() == 0) {
            ...
            String fileName = "Quản lý loại đồ uống";
            String title = "Chi tiết thông tin loại đồ uống";
